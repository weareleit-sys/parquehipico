...
export const leadCategoryDefinitions: LeadCategoryDefinition[] = [
  ...
  },
  {
    ...
    searchPrompt: 'busca wedding planners, banqueterías de matrimonios, organizadores de bodas, productoras de matrimonios, centros de eventos, hoteles, salones, parcelas y venues que ofrezcan o recomienden locaciones para matrimonios. Prioriza negocios con teléfono, email o web oficial verificable en la zona. Excluye tiendas de vestidos, joyerías, florerías, maquillaje, fotografía o decoración aislada si no influyen claramente en la elección del lugar.',
  ...
  },
  {
    ...
    searchPrompt: 'interprétala como eventos familiares y celebraciones privadas, NO como tiendas de cumpleaños. Busca organizadores de celebraciones, banqueterías, productoras pequeñas, catering, planners para aniversarios, fiestas privadas, hoteles, cabañas, centros de eventos, salones, restaurantes con eventos y venues que podrían necesitar un espacio outdoor complementario, más grande, más campestre o con bosque. Prioriza negocios con teléfono, email o web oficial verificable. Excluye tiendas de artículos para fiestas, cotillón, decoración, globos, tortas, piñaterías, dulcerías, jugueterías y negocios dedicados principalmente a vender productos.',
