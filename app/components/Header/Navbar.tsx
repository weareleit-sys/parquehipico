...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed inset-0 bg-slate-950 z-[49] flex flex-col justify-start items-center pt-32 transition-all duration-500 ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible pointer-events-none'}`}>
